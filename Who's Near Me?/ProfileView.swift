    ...
    var body: some View {
        NavigationView {
            ...
            .sheet(isPresented: $showingEditProfileSheet) {
                EditProfileView(userId: userId, profile: profile ?? Profile(id: userId, username: "", bio: "", profilePictureUrl: nil, interests: [], gender: nil, socialMediaLinks: nil, availabilityStatus: nil, birthday: nil), onSave: { updatedProfile in
